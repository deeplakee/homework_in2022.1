...
//把IP地址的四个数字以字符串读入并把IP地址转化为十进制表示（上限）
long long down_ipaddress_to_ipnum(char arr1[4],char arr2[4],char arr3[4],char arr4[4],char arr5[4]);
//把IP地址的四个数字以字符串读入并把IP地址转化为十进制表示（下限）